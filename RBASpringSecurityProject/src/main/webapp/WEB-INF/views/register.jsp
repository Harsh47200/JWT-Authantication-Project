...
.wrapper form .field .custom-select select:focus ~ label, .wrapper form .field .custom-select select:not(:placeholder-shown) 
	~ label {
	top: -10px;
	font-size: 14px;
	color: #4158d0;
...
.wrapper form .field .custom-select select:focus, .wrapper form .field .custom-select select:not(:placeholder-shown)
	{
	border-color: #4158d0;
}
...
.wrapper form .field .custom-select::after {
	...
	height: 10px;
	background-image:
		url('data:image/svg+xml;base64,PHN2ZyBmaWxsPSIjNDA0MDQwIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAxMCAxMCI+PHBhdGggZD0iTTUgOWw1LTUgMS0xLTYgNi02LTZsLTEgMSA1IDV6Ii8+PC9zdmc=');
	background-size: 100%;
	...
	<div class="wrapper">
		...
		<form action="${pageContext.request.contextPath}/register"
			...
			<div class="signup-link">
				Already a member? <a
					href="${pageContext.request.contextPath}/login-page">Login</a>
			</div>
		</form>
	</div>
